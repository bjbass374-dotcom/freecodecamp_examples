...
#print de animal sound with de same method on diferent Classes
animal_sound(Cat())
animal_sound(Bird())
animal_sound(Monkey())

#another example with social media post 
...
#and finally, another example with inheritance-based polymorphism
class Animal:
   def speak(self):
...
#the same output can doing also with list
